...
{
    public class GetProductUnitConversionsPagedByProductQueryValidator
       : AbstractValidator<GetProductUnitConversionsPagedByProductQuery>
    {
        public GetProductUnitConversionsPagedByProductQueryValidator(
            ProductUnitConversionPageByProductDtoValidator dtoValidator)
        {
            RuleFor(x => x.Dto)
