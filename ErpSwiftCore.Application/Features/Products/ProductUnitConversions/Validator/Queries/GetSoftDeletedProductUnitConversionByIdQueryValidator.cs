...
{
    public class GetSoftDeletedProductUnitConversionByIdQueryValidator
        : AbstractValidator<GetSoftDeletedProductUnitConversionByIdQuery>
    {
        public GetSoftDeletedProductUnitConversionByIdQueryValidator()
        {
