...
{
    public class GetProductUnitConversionWithToUnitQueryValidator
     : AbstractValidator<GetProductUnitConversionWithToUnitQuery>
    {
        public GetProductUnitConversionWithToUnitQueryValidator()
        {
