using ErpSwiftCore.Application.Features.Products.ProductTaxes.Validator.Queries;
...
namespace ErpSwiftCore.Application.Features.Products.ProductUnitConversions.Validator.Queries
{
    ...
    public class GetProductUnitConversionsPagedInactiveSoftDeletedQueryValidator
        : AbstractValidator<GetProductUnitConversionsPagedInactiveSoftDeletedQuery>
    {
        public GetProductUnitConversionsPagedInactiveSoftDeletedQueryValidator(
