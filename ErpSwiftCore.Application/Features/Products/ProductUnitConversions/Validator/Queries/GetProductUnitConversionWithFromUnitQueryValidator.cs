...
{
    public class GetProductUnitConversionWithFromUnitQueryValidator
        : AbstractValidator<GetProductUnitConversionWithFromUnitQuery>
    {
        public GetProductUnitConversionWithFromUnitQueryValidator()
        {
