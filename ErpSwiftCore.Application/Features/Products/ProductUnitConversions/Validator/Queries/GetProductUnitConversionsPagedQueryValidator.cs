...
namespace ErpSwiftCore.Application.Features.Products.ProductUnitConversions.Validator.Queries
{
    ...
    public class GetProductUnitConversionsPagedQueryValidator
        : AbstractValidator<GetProductUnitConversionsPagedQuery>
    {
        public GetProductUnitConversionsPagedQueryValidator(
