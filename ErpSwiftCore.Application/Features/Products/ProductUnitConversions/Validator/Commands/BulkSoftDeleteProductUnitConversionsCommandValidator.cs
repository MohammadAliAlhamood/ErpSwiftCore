...
namespace ErpSwiftCore.Application.Features.Products.ProductUnitConversions.Validator.Commands
{
    ...
    public class BulkSoftDeleteProductUnitConversionsCommandValidator
        : AbstractValidator<BulkSoftDeleteProductUnitConversionsCommand>
    {
        public BulkSoftDeleteProductUnitConversionsCommandValidator()
        {
