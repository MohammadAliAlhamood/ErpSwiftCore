...
{
    public class RestoreProductUnitConversionsRangeCommandValidator
        : AbstractValidator<RestoreProductUnitConversionsRangeCommand>
    {
        public RestoreProductUnitConversionsRangeCommandValidator()
        {
