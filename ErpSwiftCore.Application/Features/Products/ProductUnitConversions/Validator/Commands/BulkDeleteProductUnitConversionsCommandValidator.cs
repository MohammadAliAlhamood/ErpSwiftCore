...
{
    public class BulkDeleteProductUnitConversionsCommandValidator
      : AbstractValidator<BulkDeleteProductUnitConversionsCommand>
    {
        public BulkDeleteProductUnitConversionsCommandValidator()
        {
