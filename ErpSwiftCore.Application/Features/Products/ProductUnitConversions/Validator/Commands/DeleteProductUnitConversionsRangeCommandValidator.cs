...
namespace ErpSwiftCore.Application.Features.Products.ProductUnitConversions.Validator.Commands
{
    ...
    public class DeleteProductUnitConversionsRangeCommandValidator
        : AbstractValidator<DeleteProductUnitConversionsRangeCommand>
    {
        public DeleteProductUnitConversionsRangeCommandValidator()
        {
