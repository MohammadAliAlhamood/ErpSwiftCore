...
namespace ErpSwiftCore.Application.Features.Products.ProductUnitConversions.Validator.Commands
{
    ...
    public class DeleteProductUnitConversionCommandValidator
        : AbstractValidator<DeleteProductUnitConversionCommand>
    {
        public DeleteProductUnitConversionCommandValidator()
        {
