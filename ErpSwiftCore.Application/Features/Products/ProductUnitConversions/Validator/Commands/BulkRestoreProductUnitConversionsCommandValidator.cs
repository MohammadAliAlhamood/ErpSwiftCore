...
{
    public class BulkRestoreProductUnitConversionsCommandValidator
      : AbstractValidator<BulkRestoreProductUnitConversionsCommand>
    {
        public BulkRestoreProductUnitConversionsCommandValidator()
        {
