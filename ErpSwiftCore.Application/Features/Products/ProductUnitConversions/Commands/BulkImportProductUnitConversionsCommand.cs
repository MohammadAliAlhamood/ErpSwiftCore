...
namespace ErpSwiftCore.Application.Features.Products.ProductUnitConversions.Commands
{
    ...
    public class BulkImportProductUnitConversionsCommand : IRequest<APIResponseDto>
    {
        public IEnumerable<ProductUnitConversionCreateDto> Dtos { get; }

        public BulkImportProductUnitConversionsCommand(IEnumerable<ProductUnitConversionCreateDto> dtos)
        {
            Dtos = dtos;
        }
    }
