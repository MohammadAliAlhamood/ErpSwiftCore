...
{
    public class GetAllProductUnitConversionsQueryHandler
        : BaseHandler<GetAllProductUnitConversionsQuery>
    {
        private readonly IProductUnitConversionQueryService _svc;
        private readonly IMapper _mapper;
        public GetAllProductUnitConversionsQueryHandler(
            IProductUnitConversionQueryService svc,
            IMapper mapper,
            ILogger<GetAllProductUnitConversionsQueryHandler> logger
        ) : base(logger)
        {
            _svc = svc;
            _mapper = mapper;
        ...
        protected override async Task<object?> HandleRequestAsync(
            GetAllProductUnitConversionsQuery request,
            CancellationToken ct)
        {
            var list = await _svc.GetAllUnitConversionsAsync(ct);
