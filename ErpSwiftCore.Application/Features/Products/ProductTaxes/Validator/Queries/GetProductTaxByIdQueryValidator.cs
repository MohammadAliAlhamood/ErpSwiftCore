...
namespace ErpSwiftCore.Application.Features.Products.ProductTaxes.Validator.Queries
{
    ...
    public class GetProductTaxByIdQueryValidator : AbstractValidator<GetProductTaxByIdQuery>
    {
        public GetProductTaxByIdQueryValidator(IProductTaxValidationService svc)
        {
            RuleFor(x => x.TaxId)
