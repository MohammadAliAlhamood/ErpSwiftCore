...
{
    public class DeleteProductTaxCommandValidator
         : SingleTaxIdCommandValidator<DeleteProductTaxCommand>
    {
        public DeleteProductTaxCommandValidator(IProductTaxValidationService svc)
