...
{
    public class ProductCategoryDeleteRangeDtoValidator : AbstractValidator<ProductCategoryDeleteRangeDto>
    {
        public ProductCategoryDeleteRangeDtoValidator(IProductCategoryValidationService validationService)
        {
