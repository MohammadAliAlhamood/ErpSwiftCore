...
{
    public class ProductCategoryRestoreDtoValidator : AbstractValidator<ProductCategoryRestoreDto>
    {
        public ProductCategoryRestoreDtoValidator(IProductCategoryValidationService validationService)
        {
