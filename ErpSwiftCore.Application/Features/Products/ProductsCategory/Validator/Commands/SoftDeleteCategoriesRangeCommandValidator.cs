...
namespace ErpSwiftCore.Application.Features.Products.ProductsCategory.Validator.Commands
{
    ...
    public class SoftDeleteCategoriesRangeCommandValidator
        : IdListCommandValidator<SoftDeleteCategoriesRangeCommand>
    {
        public SoftDeleteCategoriesRangeCommandValidator(IProductCategoryValidationService vs)
