...
{
    public class AddCategoriesRangeCommandValidator : AbstractValidator<AddCategoriesRangeCommand>
    {
        public AddCategoriesRangeCommandValidator(IProductCategoryValidationService vs)
        {
