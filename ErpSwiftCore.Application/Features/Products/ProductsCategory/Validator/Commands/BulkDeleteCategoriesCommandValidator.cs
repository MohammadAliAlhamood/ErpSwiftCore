...
namespace ErpSwiftCore.Application.Features.Products.ProductsCategory.Validator.Commands
{
    ...
    public class BulkDeleteCategoriesCommandValidator
        : IdListCommandValidator<BulkDeleteCategoriesCommand>
    {
        public BulkDeleteCategoriesCommandValidator(IProductCategoryValidationService vs)
