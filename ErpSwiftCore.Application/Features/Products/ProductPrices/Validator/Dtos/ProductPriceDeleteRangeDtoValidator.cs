...
{
    public class ProductPriceDeleteRangeDtoValidator : AbstractValidator<ProductPriceDeleteRangeDto>
    {
        public ProductPriceDeleteRangeDtoValidator(IProductPriceValidationService vs)
        {
