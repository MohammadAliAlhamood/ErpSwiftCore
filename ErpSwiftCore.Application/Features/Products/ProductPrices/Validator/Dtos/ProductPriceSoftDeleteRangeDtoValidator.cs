...
{
    public class ProductPriceSoftDeleteRangeDtoValidator : AbstractValidator<ProductPriceSoftDeleteRangeDto>
    {
        public ProductPriceSoftDeleteRangeDtoValidator(IProductPriceValidationService vs)
        {
