...
{
    public class DeleteProductPriceCommandValidator : AbstractValidator<DeleteProductPriceCommand>
    {
        public DeleteProductPriceCommandValidator(IProductPriceValidationService vs)
        {
