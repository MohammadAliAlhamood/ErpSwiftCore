...
{
    public class SoftDeleteProductPricesRangeCommandValidator : AbstractValidator<SoftDeleteProductPricesRangeCommand>
    {
        public SoftDeleteProductPricesRangeCommandValidator(IProductPriceValidationService vs)
        {
