...
namespace ErpSwiftCore.Application.Features.Products.ProductPrices.Validator.Queries
{
    ...
    public class GetPricesCountByProductQueryValidator : AbstractValidator<GetPricesCountByProductQuery>
    {
        public GetPricesCountByProductQueryValidator(IProductPriceValidationService vs)
        {
