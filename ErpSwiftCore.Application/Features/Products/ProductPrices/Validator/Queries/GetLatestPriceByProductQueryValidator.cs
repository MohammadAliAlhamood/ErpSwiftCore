...
namespace ErpSwiftCore.Application.Features.Products.ProductPrices.Validator.Queries
{
    ...
    public class GetLatestPriceByProductQueryValidator : AbstractValidator<GetLatestPriceByProductQuery>
    {
        public GetLatestPriceByProductQueryValidator(IProductPriceValidationService vs)
        {
