...
{
    public class BulkRestoreProductBundlesCommandValidator : AbstractValidator<BulkRestoreProductBundlesCommand>
    {
        public BulkRestoreProductBundlesCommandValidator(IProductBundleValidationService validationService)
        {
