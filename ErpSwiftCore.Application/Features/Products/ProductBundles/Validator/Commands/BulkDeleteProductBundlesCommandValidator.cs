...
{
    public class BulkDeleteProductBundlesCommandValidator : AbstractValidator<BulkDeleteProductBundlesCommand>
    {
        public BulkDeleteProductBundlesCommandValidator(IProductBundleValidationService validationService)
        {
