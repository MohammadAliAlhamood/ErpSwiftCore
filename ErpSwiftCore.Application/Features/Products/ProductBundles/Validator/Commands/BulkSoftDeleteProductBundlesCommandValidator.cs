...
{
    public class BulkSoftDeleteProductBundlesCommandValidator : AbstractValidator<BulkSoftDeleteProductBundlesCommand>
    {
        public BulkSoftDeleteProductBundlesCommandValidator(IProductBundleValidationService validationService)
        {
