...
namespace ErpSwiftCore.Application.Features.Products.ProductBundles.Validator.Commands
{
    ...
    public class RestoreProductBundlesRangeCommandValidator : AbstractValidator<RestoreProductBundlesRangeCommand>
    {
        public RestoreProductBundlesRangeCommandValidator(IProductBundleValidationService validationService)
        {
