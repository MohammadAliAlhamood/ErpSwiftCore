...
{
    public class GetProductBundleWithParentProductQueryValidator : AbstractValidator<GetProductBundleWithParentProductQuery>
    {
        public GetProductBundleWithParentProductQueryValidator(IProductBundleValidationService validationService)
        {
