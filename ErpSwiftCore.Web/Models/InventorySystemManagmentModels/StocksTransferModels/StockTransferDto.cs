...
namespace ErpSwiftCore.Web.Models.InventorySystemManagmentModels.StocksTransferModels
{
    /// <summary>
    ...
    public class StockTransferViewModel  
    {
        ...
        public IEnumerable<SelectListItem> FromWarehouseList { get; set; }
        public IEnumerable<SelectListItem> ToWarehouseList { get; set; }
